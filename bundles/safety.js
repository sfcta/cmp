...
var api_server = 'http://api.sfcta.org/api/switrs_viz2';
var api_totals = 'http://api.sfcta.org/api/switrs_totals';
...
var queryurl = '';
var label = '';
var incColor = { 'Fatal': "#ff0000", 'Non-fatal': "#800080" };
var incOpacity = { 'Fatal': 1, 'Non-fatal': 0.15 };
var missingColor = '#ccc';
var popup = null;
var collisionLayer = void 0;
var mapLegend = void 0;
var allJSONData = void 0;

//Initialization of selective aspects
var popSelIntersection = void 0;
var selectedIntersection = void 0,
    prevSelectedIntersection = void 0;
...
function getSWITRSinfo() {
  ...
  if (app.sliderValue === "All Years") {
    ...
    var url = api_server + '?select=st_asgeojson,year,biccol,pedcol,bickill,pedkill,street_names,bicinj,pedinj';
...
function hoverFeature(e) {
  ...
  var geo = highlightedGeo.feature;

  //Fixing the street_names for easier readability and have it dependent on query information.
  var intersectionName = highlightedGeo.feature.street_names.replace(/'/g, "").replace('[', "").replace(']', "").replace(/,/g, ' and');
  ...
  if (selectedIntersection) {
    ...
    if (oldHoverTarget) {
      if (oldHoverTarget.feature.street_names != selectedIntersection.feature.street_names) collisionLayer.resetStyle(oldHoverTarget);
    }
...
function clickedOnFeature(e) {
  var clickedIntersection = e.target.feature;
  ...
  var intersectionName = selectedIntersection.feature.street_names.replace(/'/g, "").replace('[', "").replace(']', "").replace(/,/g, ' and');
  app.chartTitle = 'ALL COLLISIONS at ' + intersectionName + ':';

  popSelIntersection = L.popup().setLatLng(e.latlng).setContent(intersectionName).addTo(mymap);
  ...
  var jsonData = allJSONData.filter(function (row) {
    return row.street_names == selectedIntersection.feature.street_names;
  });
...
//initialize labels
var yearLabels = ['2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017'];
