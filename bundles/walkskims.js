...
var store = shared.store || (shared.store = new (__webpack_require__(110))());
...
if (__webpack_require__(6)) {
  ...
  var ArrayIterators = __webpack_require__(73);
...
var core = __webpack_require__(22);
var LIBRARY = __webpack_require__(35);
var wksExt = __webpack_require__(150);
...
var toLength = __webpack_require__(244);
...
module.exports = !__webpack_require__(50) && !__webpack_require__(113)(function () {
...
var create = __webpack_require__(254);
var descriptor = __webpack_require__(119);
var setToStringTag = __webpack_require__(114);
var IteratorPrototype = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(48)(IteratorPrototype, __webpack_require__(31)('iterator'), function () { return this; });
...
var step = __webpack_require__(252);
var Iterators = __webpack_require__(55);
var toIObject = __webpack_require__(75);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(276));
...
var _getIterator2 = __webpack_require__(257);

var _getIterator3 = _interopRequireDefault(_getIterator2);

var _values = __webpack_require__(454);
...
var _vueSliderComponent = __webpack_require__(384);

var _vueSliderComponent2 = _interopRequireDefault(_vueSliderComponent);

var _vueSelect = __webpack_require__(542);
...
var DISTANCE_BINS = [0, 0.25, 0.5, 1, 5, 20, 50];
var DISTANCE_COLORS = ['#ccc', '#1a9850', '#91cf60', '#d9ef8b', '#ffffbf', '#fee08b', '#fc8d59', '#d73027'];
var DEFAULT_ZOOM = 12;
...
var iconOrig = maplib.iconOrig;
var iconDest = maplib.iconDest;
var styles = maplib.styles;
var getLegHTML = maplib.getLegHTML;
var geoColorFunc = maplib.colorFunc.distance;
var geoLayer = void 0;
var selTAZProps = void 0;
...
info.update = function (props) {
  var seltaz = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ['', ''];
  var odind = arguments[2];
  ...
  this._div.innerHTML = '<h4>Information</h4>' + '<b>' + pref + seltaz[0] + '</b>, Neighborhood: ' + seltaz[1] + '<br/>' + (props ? '<b>' + suff + props.taz + '</b>, Neighborhood: ' + props.nhood + '<br/> <b>Distance: ' + props.distance + ' miles</b>' : 'Hover over a TAZ');
};
info.addTo(mymap);
...
function queryServer() {
  ...
  var dataurl = api_server + app.tableSelVal.label + '?';
  var urlparams = app.dirSel == app.dirOrig ? 'otaz' : 'dtaz';
...
function styleByColorFunc(feat) {
  var color = maplib.getColorByBin(feat.distance, DISTANCE_BINS, DISTANCE_COLORS);
...
function addGeoLayer(jsonData) {
  ...
  geoLayer = L.geoJSON((0, _values2.default)(geoFeatures), {
...
function updateOptionsData() {
  var tazSelOptions = [];
  fetch(api_server + GEO_VIEW + '?select=geometry,taz,centroid,county,nhood').then(function (resp) {
    return resp.json();
  }).then(function (jsonData) {
  ...
  var tableSelOptions = [];
  fetch(api_server + TABLES_VIEW).then(function (resp) {
    return resp.json();
  }).then(function (jsonData) {
...
function usrOptionChanged(thing) {
  ...
  if (app.tazSelVal && app.tableSelVal) {
    if (typeof app.tazSelVal.value !== 'undefined') {
      ...
      var cen_coords = getTAZCentroid(geoFeatures[app.tazSelVal.value].centroid);
...
var getKeys = __webpack_require__(255);
var toIObject = __webpack_require__(75);
var isEnum = __webpack_require__(479).f;
module.exports = function (isEntries) {
  return function (it) {
    var O = toIObject(it);
    var keys = getKeys(O);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(106);
var $values = __webpack_require__(480)(false);
